...
def detect_attr(model, pic_path, threshold=0.6):
...
''
# path = "/home/czd-2019/Projects/celebA_dataset/img_align_celeba/193087.jpg"
path = "/home/czd-2019/Projects/face-attribute-prediction/self_network/model_pic_test/0001.jpg"
...
model = AttrPre()
model.to(device)
checkpoint = torch.load("/home/czd-2019/Projects/face-attribute-prediction/self_network/checkpoint/checkpoint_epoch80.pth")
